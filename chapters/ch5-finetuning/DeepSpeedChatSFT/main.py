...
def main():
    import os
    os.environ["MASTER_PORT"] = "29501"  # 改为可用端口
    args = parse_args()
    ...
    # 导入本地存储的模型相关文件
    modeling_baichuan = import_module("models.baichuan_7b.modeling_baichuan")
    tokenization_baichuan = import_module("models.baichuan_7b.tokenization_baichuan")
